...
class Main {
    ...
    public static void main(String[] args) {
        ...
        panel.addSpace(0.03f, 150f, 1600, 1000);
        ...
        panel.space.addWall(0,1000,1000,400);
...
//        panel.space.addLine(050,249,700,599);
        for (int i = 0; i <10 ; i++) {
            ...
            int y = 800;
            for (int j = 0; j < 10; j++) {
//                panel.space.addThing(new Vector2(0f, 0f), 0.05f, x, y+20*j, 10f , Material.LapisLazuli);
            }
        }
        ...
        panel.addMouseListener(new MouseListener() {
            ...
            public void mousePressed(MouseEvent e) {
                panel.space.addThing(new Vector2(-0,0), 0.07f, e.getX(), e.getY(), 10, Material.Steel);
            }
