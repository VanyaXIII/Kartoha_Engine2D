...
public class Material {
    ...
    public static Material Steel = new Material(7900, new Color(175, 175, 175),0.9f, 0.6f);
    ...
    public static Material Constantin = new Material(1000, Color.GREEN, 0.5f, 0.6f);
}
