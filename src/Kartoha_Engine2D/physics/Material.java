...
public class Material {
    ...
    public static final Material Wood = new Material(500, new Color(124, 67, 11),0.5f, 0f);
    ...
    public static final Material Constantin = new Material(1000, Color.RED, 0.7f, 0.7f);
}
